...
<th>사용여부</th>
<td>
<input type="radio" name="activeCategory" value="true"
id="activeCategory_true">
<label for="activeCategory_true">사용</label>

<input type="radio" name="activeCategory" value="false"
id="activeCategory_false">
...
<tr>
    ...
    <td>
        <input type="radio" name="authority" value="ALL" id="authority_USER">
        <label for="authority_ALL">
        회원 + 관리자
        </label>
        </td>
        ...
        <td>
            <input type="radio" name="authority" value="ALL" id="authority_ADMIN">
            <label for="authority_ALL">
             관리자
            </label>
            </td>
